...
namespace Task.Controllers
{
    ...
    {
        private DbContextSchool db = new DbContextSchool();
        ...
        public ActionResult Create([Bind(Include = "StudentId,Address,PhoneNumber")] StudentDetails studentDetails)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentId,Address,PhoneNumber")] StudentDetails studentDetails)
        {
            if (ModelState.IsValid)
            {
